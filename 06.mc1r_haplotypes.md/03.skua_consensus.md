# MC1R bcftools consensus hap1 + hap2 — *S. skua*
...
HAPDIR="/data2/lab2/lucila/BIO295B_FernandaCavieres/data/mc1r_skua/haplotipos"
...
samtools faidx "$REF" "$REGION" | sed "s/^>.*/>SC_chilensis_ref/" > "$HAPDIR/MC1R_skua_haplotipos.fasta"
for NOMBRE in "${MUESTRAS[@]}"; do
    cat "$HAPDIR/${NOMBRE}_hap1.fa" >> "$HAPDIR/MC1R_skua_haplotipos.fasta"
    cat "$HAPDIR/${NOMBRE}_hap2.fa" >> "$HAPDIR/MC1R_skua_haplotipos.fasta"
done

echo "============================================"
echo " LISTO! $(date '+%Y-%m-%d %H:%M:%S')"
echo " Archivo final: $HAPDIR/MC1R_skua_haplotipos.fasta"
grep -c "^>" "$HAPDIR/MC1R_skua_haplotipos.fasta"
echo " secuencias en total (ref + 2 hap x muestra)"
echo "============================================"
```
source activate jcvi_env
seqkit translate -F /data2/lab2/lucila/BIO295B_FernandaCavieres/data/mc1r_skua/haplotipos/MC1R_skua_haplotipos.fasta > /data2/lab2/lucila/BIO295B_FernandaCavieres/data/mc1r_skua/haplotipos/MC1R_skua_proteinas.faa